...
namespace Gamekit2D
{
    public class PlayerInput : InputComponent, IDataPersister
    {
        ...
        public InputButton Interact = new InputButton(KeyCode.P, XboxControllerButtons.Y);
        public InputButton MeleeAttack = new InputButton(KeyCode.X, XboxControllerButtons.X);
        public InputButton RangedAttack = new InputButton(KeyCode.C, XboxControllerButtons.B);
        public InputButton Jump = new InputButton(KeyCode.Z, XboxControllerButtons.A);
